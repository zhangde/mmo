...
import com.tongwan.common.ai.behaviortree.node.SequenceNode;
		...
		addChildItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case SELECTOR:
					...
					newNode=new SelectorNode(mainJFrame.getListPanel().current,contentSEL);
				...
				case SEQUENCE:
					...
					newNode=new SequenceNode(mainJFrame.getListPanel().current,contentSEQ);
					treeJPanel.addNode(newNode);
					break;
				case CONDITION:
